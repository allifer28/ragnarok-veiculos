...
const sampleCars = [
  {
    ...
    imagem: "/images/cars/honda/civic-2023.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/toyota/corolla-2022.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/volkswagen/golf-2023.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/honda/accord-2022.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/toyota/camry-2023.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/volkswagen/jetta-2022.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/honda/hrv-2023.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    imagem: "/images/cars/toyota/rav4-2022.jpg",
    createdAt: new Date(),
    updatedAt: new Date(),
  },
]
